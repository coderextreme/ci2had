...
menu_str = '''
    ...
    <Viewpoint position="0 20 110" />
      ...
      <ROUTE fromNode="ScriptToggle" fromField="startTime" toNode="standin_clock" toField="startTime"/>
      <ROUTE fromNode="ScriptToggle" fromField="stopTime" toNode="standin_clock" toField="stopTime"/>
      <ROUTE fromNode="ScriptToggle" fromField="checked" toNode="standin_clock" toField="enabled"/>
